      ...
      <main className="w-full max-w-md space-y-0">
        {loading ? (
          ...
          <div className="w-full max-w-md mx-auto pt-6 px-4 space-y-4">
            <SleepCard data={data?.sleepLogs} allergyLogs={data?.allergyLogs} supplementLogs={data?.supplementLogs} splintLogs={data?.biteSplintLogs} updateData={updateData} forceSync={forceSync} />
